...
public extension Vector4 {
    ...
    static func lerp(_ value1: Vector4, _ value2: Vector4, amount: Float) -> Vector4 {
        return Vector4(MathHelper.lerp(value1.x, value2.x, amount: amount),
                       MathHelper.lerp(value1.y, value2.y, amount: amount),
                       MathHelper.lerp(value1.z, value2.z, amount: amount),
                       MathHelper.lerp(value1.w, value2.w, amount: amount))
    }
    ...
    static func lerp(_ value1: Vector4, _ value2: Vector4, amount: Float, result: inout Vector4) {
        ...
        result.w = MathHelper.lerp(value1.w, value2.w, amount: amount)
    }
    ...
    ///   - amount: Weighting value (between 0.0 and 1.0).
    /// - Returns: The result of the linear interpolation of the specified vectors.
    static func lerpPrecise(_ value1: Vector4, _ value2: Vector4, amount: Float) -> Vector4 {
        return Vector4(MathHelper.lerpPrecise(value1.x, value2.x, amount: amount),
                       MathHelper.lerpPrecise(value1.y, value2.y, amount: amount),
                       MathHelper.lerpPrecise(value1.z, value2.z, amount: amount),
                       MathHelper.lerpPrecise(value1.w, value2.w, amount: amount))
    }
    ...
    ///   - amount: Weighting value (between 0.0 and 1.0).
    ///   - result: The result of the linear interpolation of the specified vectors as an `inout` parameter.
    static func lerpPrecise(_ value1: Vector4, _ value2: Vector4, amount: Float, result: inout Vector4) {
